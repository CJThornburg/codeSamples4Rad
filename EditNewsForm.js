...
const EditNewsForm = ({
  ...
  const handleSubmit = async (event) => {
    ...
    const titleErrors = validateTitle("newsTitle", formValues.title, setErrors);
    ...
    const bodyErrors = validateBody("newsBody", formValues.body, setErrors);
    ...
    const linkErrors = validateLink("newsLink", formValues.link, setErrors);
